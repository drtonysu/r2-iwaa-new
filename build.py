...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Fraunces:ital,opsz,wght@0,9..144,500;0,9..144,600;1,9..144,500&display=swap" rel="stylesheet">
    ...
    <section class="band">
      <div class="wrap split split--flip reveal">
        ...
        <div class="split__body">
          ...
          <hr class="rule">
          <p class="lead">Taipei centre prepares and ships the materials to every partner clinic — so your care does not change with your city.</p>
    ...
    <section class="band band--navy">
      <div class="wrap split reveal">
        <div class="split__body">
          ...
          <h2>Dr. Tony Su</h2>
          <hr class="rule">
          <p class="lead">Founder and Medical Director. He leads every clinical protocol at R2-IWAA and delivers it.</p>
...
founder = f"""    <section class="hero hero--page">
    ...
    <section class="band band--ivory">
      <div class="wrap founder reveal">
        <div class="portrait"><img src="img/founder-portrait.webp" alt="Dr. Tony Su in a white physician's coat, calm and composed, standing before a framed artwork"></div>
        <div>
...
iv_drips = {
    ...
    "iv-vitamin-c.html": {
        ...
        "hero_alt": "Editorial still-life on polished black marble against navy velvet: a split pomegranate with ruby seeds spilling, halved kiwi with emerald flesh, dew-fresh strawberries and dark camu-camu berries, warm golden rim light",
        "editorial": {
    ...
    "iv-sport.html": {
        ...
        "hero_img": "iv-08-sport-hero.webp",
        "hero_alt": "Editorial hero still-life on polished black marble against navy velvet: a folded ivory linen towel with a smooth river stone, a sprig of eucalyptus and a small amber apothecary bottle, warm golden rim light with deep shadows on the left for text overlay",
        "editorial": {
